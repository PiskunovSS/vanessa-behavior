...
Процедура ОбновитьСтрокуЗапуска()
	...
	ПараметрыОтладчика = Объект.ДополнительныеПараметрыМенеджера;
...
&НаКлиенте
Процедура ДополнительныеПараметрыМенеджераПриИзменении(Элемент)
...
&НаКлиенте
Процедура НеЗакрыватьПриВыполненииСценариевПриИзменении(Элемент)
